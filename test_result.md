...
## user_problem_statement: "Hizmet listesine excel ve pdf aktar ile yazdır ve paylaş(WhatsApp) butonları ekleyeceğiz. Butonları basınca işlevler yerine getirilecek."
...
## test_plan:
  current_focus:
    ...
    - "PDF export endpoint"
    - "Excel export button and functionality"
